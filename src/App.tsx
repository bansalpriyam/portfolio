...
import { Menu, X, Github, Linkedin, Mail, Phone, MapPin, Download, User, Briefcase, GraduationCap, Code, Award, ExternalLink, Sun, Moon, Monitor, MessageCircle, Send } from 'lucide-react';
...
import { ParallaxSection, MagneticButton, RevealText } from './components/AdvancedAnimations';
    ...
    >
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.technologies.slice(0, isExpanded ? project.technologies.length : 3).map((tech) => (
            <span
              key={tech}
        ...
        {isExpanded && project.metrics && (
          ...
          >
            {project.metrics.map((metric) => (
              <div key={metric.label} className="text-center p-2 bg-slate-700/50 rounded-lg">
...
const AppContent = () => {
  ...
  // Enhanced projects data with complete information
  const projects = [
    {
      id: 'nts-platform',
      ...
      longDescription: 'Comprehensive trade platform enabling seamless cross-border transactions through advanced API integration, microservices architecture, and real-time data synchronization across multiple international markets. The platform handles millions of transactions daily with enterprise-grade security and compliance.',
      technologies: ['REST APIs', 'Spring Boot', 'OAuth2', 'Microservices', 'TLS Encryption', 'JSON', 'Postman', 'Swagger'],
      images: [
      ...
      features: [
        'Real-time cross-border data synchronization',
        'Enterprise-grade security with OAuth2 and TLS encryption',
        'Microservices architecture for scalability',
        'Comprehensive API documentation with Swagger',
        'Multi-country compliance and regulatory support'
      ],
      challenges: [
        'Complex international regulatory requirements',
        'Real-time data synchronization across time zones',
        'Ensuring 99.9% uptime for critical trade operations',
        'Managing diverse API standards across countries'
      ],
      solutions: [
        ...
        'Standardized API interfaces with clear documentation'
      ]
    },
    {
      id: 'ai-chatbot',
      ...
      longDescription: 'Advanced conversational AI system built with natural language processing and machine learning algorithms, featuring context awareness, entity recognition, and continuous learning capabilities. The system processes thousands of queries daily with human-like understanding.',
      technologies: ['NLP', 'Machine Learning', 'Python', 'TensorFlow', 'Entity Recognition', 'Neural Networks', 'Data Preprocessing'],
      images: [
      ...
      features: [
        ...
        'Real-time entity recognition and extraction',
      ...
      challenges: [
        ...
        'Reducing false positive responses',
        'Scaling to handle high query volumes'
      ],
      solutions: [
        'Implemented advanced NLP preprocessing techniques',
        'Designed context-aware neural network architecture',
        'Created comprehensive training datasets',
        'Optimized model performance for real-time responses'
      ]
    },
    {
      id: 'vtol-drone',
      ...
      longDescription: 'Innovative vertical takeoff and landing aircraft design featuring autonomous targeting systems, advanced flight control algorithms, and precision payload delivery mechanisms. The drone incorporates cutting-edge computer vision for accurate target identification.',
      technologies: ['UAV Design', 'SIFT Algorithm', 'Autonomous Systems', 'Flight Control', 'Computer Vision', 'Embedded Systems'],
      images: [
      ...
      features: [
        'Autonomous target identification and tracking',
        'Precision payload delivery system',
        'Advanced flight stabilization algorithms',
        'Real-time telemetry and monitoring',
        'Fail-safe emergency landing protocols'
      ],
      challenges: [
        'Balancing payload capacity with flight stability',
        'Achieving precise targeting accuracy',
        'Optimizing power consumption for extended flight',
        'Ensuring reliable autonomous operation'
      ],
      solutions: [
        'Engineered lightweight yet robust frame design',
        'Implemented SIFT algorithm for target recognition',
        'Optimized rotor configuration for maximum efficiency',
        'Developed comprehensive testing and validation protocols'
      ]
    }
  ];
